...
#save rasters
#write prediction
raster::writeRaster(predictions$mean_predictions,filename = paste0("data/derived_data/model_outputs_by_species/",model_to_run,"/mean_prediction_",species_name,".grd"))

#write SDM uncertainty
raster::writeRaster(predictions$mean_predictions,filename = paste0("data/derived_data/model_outputs_by_species/",model_to_run,"/boostrapped_sd_",species_name,".grd"))
